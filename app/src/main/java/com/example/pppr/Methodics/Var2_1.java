...
public class Var2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_var21);
        ...
        final EditText input = new EditText(Var2_1.this);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Var2_1.this);
        builder.setMessage("")
